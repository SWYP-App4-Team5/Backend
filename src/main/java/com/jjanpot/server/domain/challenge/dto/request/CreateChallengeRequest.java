...
public record CreateChallengeRequest(
	...
	@Schema(description = "팀 유형", example = "친구")
	@NotNull(message = "팀 유형은 필수입니다.")
	TeamType teamType,

	@Schema(description = "최대 참여 인원 (2~8명)", example = "5")
	...
	@Schema(description = "팀 전체 목표 금액 (최대 3,000,000원)", example = "300000")
	...
	@Schema(description = "인당 최소 목표 금액 (5,000 ~ 300,000원)", example = "50000")
